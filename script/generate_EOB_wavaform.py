...
HP , HC = get_td_waveform(approximant = "SEOBNRv4",mass1 = 20 , mass2 = 20 , delta_t = 1.0/4096 , f_lower = 20,LALPNOrder = pnorder[-1])
...
for i in range(len(HP)):
    f.write("%E %E %E\n" % (HP.sample_times[i]/(40*4.9*pow(10, -6)), H_amp[i], H_phase[i])) 
