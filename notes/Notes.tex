...
\begin{figure}
	\includegraphics[width=5.0in]{/home/ashok/constraintongwwaveform/plots/hp_pycbc_teob_comparision.pdf}
	\caption{The figure shows the }
	\label{fig:teobhp}
\end{figure}

\begin{figure}
	\includegraphics[width=5.0in]{/home/ashok/constraintongwwaveform/plots/h22_pycbc_teob_comparision.pdf}
	\caption{The figure shows the }
	\label{fig:teobh22}
\end{figure} 
...
\begin{figure}
 	\includegraphics[width=5.0in]{/home/ashok/constraintongwwaveform/plots/BOB_balanceLaw_with_teobinitial_Cndtn.pdf}
 	\caption{The figure shows the }
 	\label{fig:teobh22}
\end{figure} 
...
The super-momentum balance law in equation 1.1 can in rewritten using the expression for $\Psi_{2}$  the asymptotic past and future in the following way. This is also equation 2.23 in \cite{AshtekarCBC} where the $\eth$ operator is given in 2.10 in \cite{AshtekarCBC}.
The expression for $\Psi_{2}$ is given in equation 43 in \cite{Liu}
...
Now we can use the above equation and the SXS pakage to load the various modes of waveform and apply the balance law. 
correspondence to compute right hand side of equation 3.7 for BOB. 
\begin{figure}
	\includegraphics[width=5.0in]{/home/ashok/constraintongwwaveform/plots/psi2_SXS.pdf}
	\caption{The figure shows the }
	\label{fig:psi2SXS}
\end{figure} 

\begin{figure}
	\includegraphics[width=5.0in]{/home/ashok/constraintongwwaveform/plots/Balance_SXS.pdf}
	\caption{The figure shows the }
	\label{fig:Balance_SXS}
\end{figure}
\section*{References}
